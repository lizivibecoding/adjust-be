package com.hongguoyan.module.infra.service.logger;
...
import com.hongguoyan.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.hongguoyan.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.hongguoyan.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.hongguoyan.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.hongguoyan.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.hongguoyan.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("adjust-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("adjust-test");
