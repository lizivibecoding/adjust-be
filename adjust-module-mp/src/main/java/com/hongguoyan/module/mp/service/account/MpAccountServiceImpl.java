package com.hongguoyan.module.mp.service.account;
...
import com.hongguoyan.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import com.hongguoyan.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import com.hongguoyan.module.mp.convert.account.MpAccountConvert;
import com.hongguoyan.module.mp.dal.dataobject.account.MpAccountDO;
import com.hongguoyan.module.mp.dal.mysql.account.MpAccountMapper;
import com.hongguoyan.module.mp.enums.ErrorCodeConstants;
...
import static com.hongguoyan.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 adjust-module-mp - 表结构未导入][参考 https://doc.iocoder.cn/mp/build/ 开启]");
            }
