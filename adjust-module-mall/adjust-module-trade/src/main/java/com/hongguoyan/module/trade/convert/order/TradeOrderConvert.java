package com.hongguoyan.module.trade.convert.order;
...
import com.hongguoyan.module.product.api.property.dto.ProductPropertyValueDetailRespDTO;
import com.hongguoyan.module.product.api.sku.dto.ProductSkuRespDTO;
import com.hongguoyan.module.product.api.sku.dto.ProductSkuUpdateStockReqDTO;
import com.hongguoyan.module.product.api.spu.dto.ProductSpuRespDTO;
import com.hongguoyan.module.promotion.api.combination.dto.CombinationRecordCreateReqDTO;
import com.hongguoyan.module.trade.api.order.dto.TradeOrderRespDTO;
import com.hongguoyan.module.trade.controller.admin.base.member.user.MemberUserRespVO;
import com.hongguoyan.module.trade.controller.admin.base.product.property.ProductPropertyValueDetailRespVO;
import com.hongguoyan.module.trade.controller.admin.order.vo.*;
import com.hongguoyan.module.trade.controller.app.base.property.AppProductPropertyValueDetailRespVO;
import com.hongguoyan.module.trade.controller.app.order.vo.*;
import com.hongguoyan.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import com.hongguoyan.module.trade.controller.app.order.vo.item.AppTradeOrderItemRespVO;
...
import com.hongguoyan.module.trade.framework.delivery.core.client.dto.ExpressTrackRespDTO;
import com.hongguoyan.module.trade.framework.order.config.TradeOrderProperties;
import com.hongguoyan.module.trade.service.brokerage.bo.BrokerageAddReqBO;
...
import static com.hongguoyan.framework.common.util.collection.CollectionUtils.convertMap;
import static com.hongguoyan.framework.common.util.collection.CollectionUtils.convertMultiMap;
import static com.hongguoyan.framework.common.util.date.LocalDateTimeUtils.addTime;
...
public interface TradeOrderConvert {
    ...
    default BrokerageAddReqBO convert(MemberUserRespDTO user, TradeOrderItemDO item,
        ...
        if (BooleanUtil.isTrue(spu.getSubCommissionType())) {
            // 特殊：单独设置的佣金需要乘以购买数量。关联 https://gitee.com/adjustcode/adjust-mall-uniapp/issues/ICY7SJ
