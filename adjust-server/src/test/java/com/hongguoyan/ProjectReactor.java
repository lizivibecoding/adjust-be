...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.hongguoyan";
    private static final String ARTIFACT_ID = "adjust";
    private static final String PACKAGE_NAME = "com.hongguoyan";
    private static final String TITLE = "考研调剂系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.hongguoyan";
        String artifactIdNew = "adjust";
        String packageNameNew = "com.hongguoyan";
        String titleNew = "考研调剂系统";
