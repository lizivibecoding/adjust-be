package com.hongguoyan.module.system.service.user;
...
import com.hongguoyan.framework.common.util.collection.ArrayUtils;
import com.hongguoyan.framework.common.util.collection.CollectionUtils;
import com.hongguoyan.framework.test.core.ut.BaseDbUnitTest;
import com.hongguoyan.module.infra.api.config.ConfigApi;
import com.hongguoyan.module.infra.api.file.FileApi;
import com.hongguoyan.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.hongguoyan.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.hongguoyan.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import com.hongguoyan.module.system.controller.admin.user.vo.user.UserImportRespVO;
import com.hongguoyan.module.system.controller.admin.user.vo.user.UserPageReqVO;
import com.hongguoyan.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import com.hongguoyan.module.system.dal.dataobject.dept.DeptDO;
import com.hongguoyan.module.system.dal.dataobject.dept.PostDO;
import com.hongguoyan.module.system.dal.dataobject.dept.UserPostDO;
import com.hongguoyan.module.system.dal.dataobject.tenant.TenantDO;
import com.hongguoyan.module.system.dal.dataobject.user.AdminUserDO;
import com.hongguoyan.module.system.dal.mysql.dept.UserPostMapper;
import com.hongguoyan.module.system.dal.mysql.user.AdminUserMapper;
import com.hongguoyan.module.system.enums.common.SexEnum;
import com.hongguoyan.module.system.service.dept.DeptService;
import com.hongguoyan.module.system.service.dept.PostService;
import com.hongguoyan.module.system.service.oauth2.OAuth2TokenService;
import com.hongguoyan.module.system.service.permission.PermissionService;
import com.hongguoyan.module.system.service.tenant.TenantService;
...
import static com.hongguoyan.framework.common.util.collection.SetUtils.asSet;
import static com.hongguoyan.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.hongguoyan.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.hongguoyan.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.hongguoyan.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.hongguoyan.framework.test.core.util.AssertUtils.assertServiceException;
import static com.hongguoyan.framework.test.core.util.RandomUtils.*;
import static com.hongguoyan.module.system.enums.ErrorCodeConstants.*;
import static com.hongguoyan.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("adjustyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("adjustyuanma");
        ...
        assertEquals("adjustyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("adjustyuanma"))).thenReturn("java");
