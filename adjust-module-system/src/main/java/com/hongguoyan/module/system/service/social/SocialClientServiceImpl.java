...
import com.hongguoyan.framework.common.util.cache.CacheUtils;
import com.hongguoyan.framework.common.util.http.HttpUtils;
import com.hongguoyan.framework.common.util.object.BeanUtils;
import com.hongguoyan.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.hongguoyan.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.hongguoyan.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import com.hongguoyan.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.hongguoyan.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.hongguoyan.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.hongguoyan.module.system.dal.dataobject.social.SocialClientDO;
import com.hongguoyan.module.system.dal.mysql.social.SocialClientMapper;
import com.hongguoyan.module.system.dal.redis.RedisKeyConstants;
import com.hongguoyan.module.system.enums.social.SocialTypeEnum;
import com.hongguoyan.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.hongguoyan.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.hongguoyan.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${adjust.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${adjust.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/adjust-cloud/pulls/230
