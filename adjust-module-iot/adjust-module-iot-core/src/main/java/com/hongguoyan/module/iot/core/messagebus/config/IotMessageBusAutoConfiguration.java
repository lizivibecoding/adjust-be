package com.hongguoyan.module.iot.core.messagebus.config;

import com.hongguoyan.framework.mq.redis.core.RedisMQTemplate;
import com.hongguoyan.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import com.hongguoyan.framework.mq.redis.core.job.RedisStreamMessageCleanupJob;
import com.hongguoyan.framework.mq.redis.core.stream.AbstractRedisStreamMessage;
import com.hongguoyan.framework.mq.redis.core.stream.AbstractRedisStreamMessageListener;
import com.hongguoyan.module.iot.core.messagebus.core.IotMessageBus;
import com.hongguoyan.module.iot.core.messagebus.core.local.IotLocalMessageBus;
import com.hongguoyan.module.iot.core.messagebus.core.redis.IotRedisMessageBus;
import com.hongguoyan.module.iot.core.messagebus.core.rocketmq.IotRocketMQMessageBus;
import com.hongguoyan.module.iot.core.mq.producer.IotDeviceMessageProducer;
...
public class IotMessageBusAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "adjust.iot.message-bus", name = "type", havingValue = "local", matchIfMissing = true)
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "adjust.iot.message-bus", name = "type", havingValue = "rocketmq")
    ...
    /**
     * 特殊：由于 AdjustRedisMQConsumerAutoConfiguration 关于 Redis stream 的消费是动态注册，所以这里只能拷贝相关的逻辑！！！
     *
     * @see com.hongguoyan.framework.mq.redis.config.AdjustRedisMQConsumerAutoConfiguration
     */
    @Configuration
    @ConditionalOnProperty(prefix = "adjust.iot.message-bus", name = "type", havingValue = "redis")
