package com.hongguoyan.module.iot.gateway.config;

import com.hongguoyan.module.iot.core.messagebus.core.IotMessageBus;
import com.hongguoyan.module.iot.gateway.protocol.emqx.IotEmqxAuthEventProtocol;
import com.hongguoyan.module.iot.gateway.protocol.emqx.IotEmqxDownstreamSubscriber;
import com.hongguoyan.module.iot.gateway.protocol.emqx.IotEmqxUpstreamProtocol;
import com.hongguoyan.module.iot.gateway.protocol.http.IotHttpDownstreamSubscriber;
import com.hongguoyan.module.iot.gateway.protocol.http.IotHttpUpstreamProtocol;
import com.hongguoyan.module.iot.gateway.protocol.mqtt.IotMqttDownstreamSubscriber;
import com.hongguoyan.module.iot.gateway.protocol.mqtt.IotMqttUpstreamProtocol;
import com.hongguoyan.module.iot.gateway.protocol.mqtt.manager.IotMqttConnectionManager;
import com.hongguoyan.module.iot.gateway.protocol.mqtt.router.IotMqttDownstreamHandler;
import com.hongguoyan.module.iot.gateway.protocol.mqttws.IotMqttWsDownstreamSubscriber;
import com.hongguoyan.module.iot.gateway.protocol.mqttws.IotMqttWsUpstreamProtocol;
import com.hongguoyan.module.iot.gateway.protocol.mqttws.manager.IotMqttWsConnectionManager;
import com.hongguoyan.module.iot.gateway.protocol.mqttws.router.IotMqttWsDownstreamHandler;
import com.hongguoyan.module.iot.gateway.protocol.tcp.IotTcpDownstreamSubscriber;
import com.hongguoyan.module.iot.gateway.protocol.tcp.IotTcpUpstreamProtocol;
import com.hongguoyan.module.iot.gateway.protocol.tcp.manager.IotTcpConnectionManager;
import com.hongguoyan.module.iot.gateway.service.device.IotDeviceService;
import com.hongguoyan.module.iot.gateway.service.device.message.IotDeviceMessageService;
...
public class IotGatewayConfiguration {
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "adjust.iot.gateway.protocol.http", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "adjust.iot.gateway.protocol.emqx", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "adjust.iot.gateway.protocol.tcp", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "adjust.iot.gateway.protocol.mqtt", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "adjust.iot.gateway.protocol.mqtt-ws", name = "enabled", havingValue = "true")
    @Slf4j
