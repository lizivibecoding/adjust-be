package com.hongguoyan.module.iot.job.device;
...
import com.hongguoyan.module.iot.framework.iot.config.AdjustIotProperties;
...
public class IotDeviceOfflineCheckJob implements JobHandler {
    ...
    @Resource
    private AdjustIotProperties iotProperties;
