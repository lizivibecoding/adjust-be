...
public interface ErrorCodeConstants {
    ...
    ErrorCode PUBLISHER_IDENTITY_TYPE_INVALID = new ErrorCode(83, "发布者认证类型异常");
    ...
    ErrorCode USER_NOT_QUALIFIED = new ErrorCode(41, "你的初试总分未过{}区国家线，请确认一志愿初试分数或调剂意向省份选择");
    ErrorCode USER_PROFILE_EDIT_EXCEEDED = new ErrorCode(67, "除一志愿外信息仅允许修改两次");
