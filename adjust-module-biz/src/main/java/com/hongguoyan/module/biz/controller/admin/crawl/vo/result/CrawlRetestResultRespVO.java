...
@Schema(description = "管理后台 - 爬虫复试名单 Response VO")
@Data
public class CrawlRetestResultRespVO {
    ...
    @Schema(description = "考生编号", example = "100010001")
    private String candidateNo;

    @Schema(description = "专业名称", example = "计算机科学与技术")
    private String majorName;

    @Schema(description = "初试总分", example = "380")
