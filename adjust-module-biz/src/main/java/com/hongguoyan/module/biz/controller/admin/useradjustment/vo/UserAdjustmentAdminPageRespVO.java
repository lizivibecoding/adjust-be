...
@Schema(description = "管理后台 - 用户发布调剂（硕士招生）分页 Response VO")
@Data
public class UserAdjustmentAdminPageRespVO {
    ...
    @Schema(description = "审核人(后台账号ID)")
    private Long auditUserId;

    @Schema(description = "审核时间")
    private LocalDateTime auditTime;

    @Schema(description = "审核原因/拒绝原因")
