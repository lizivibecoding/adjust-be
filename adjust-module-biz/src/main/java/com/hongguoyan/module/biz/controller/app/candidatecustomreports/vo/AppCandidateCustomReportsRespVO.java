...
@Schema(description = "用户 APP - 考生AI调剂定制报告 Response VO")
@Data
@ExcelIgnoreUnannotated
public class AppCandidateCustomReportsRespVO {
    ...
    @ExcelProperty("生成时使用的档案ID(biz_candidate_profiles.id)")
    private Long sourceProfileId;

    @Schema(description = "生成时使用的偏好ID(biz_candidate_preferences.id)", example = "13512")
    @ExcelProperty("生成时使用的偏好ID(biz_candidate_preferences.id)")
