...
@Schema(description = "用户 APP - 套餐权益（benefit）Response VO")
@Data
public class AppVipPlanBenefitRespVO {

    @Schema(description = "权益 key", example = "view_history_list")
    ...
    @Schema(description = "权益类型：1=BOOLEAN 2=QUOTA(次数) 3=LIMIT(阈值) 4=RESOURCE(资源类)", example = "1")
    private Integer benefitType;

    @Schema(description = "数值（如 1/3/8；-1=不限）", example = "3")
    private Integer benefitValue;

    @Schema(description = "周期：0=NONE 1=DAY 2=WEEK 3=MONTH 4=YEAR 9=LIFETIME", example = "0")
