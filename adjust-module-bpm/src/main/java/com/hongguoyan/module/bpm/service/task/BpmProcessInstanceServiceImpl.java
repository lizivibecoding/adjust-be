package com.hongguoyan.module.bpm.service.task;
...
import com.hongguoyan.framework.common.util.date.DateUtils;
import com.hongguoyan.framework.common.util.json.JsonUtils;
import com.hongguoyan.framework.common.util.object.ObjectUtils;
import com.hongguoyan.framework.common.util.object.PageUtils;
import com.hongguoyan.framework.datapermission.core.annotation.DataPermission;
import com.hongguoyan.module.bpm.api.task.dto.BpmProcessInstanceCreateReqDTO;
import com.hongguoyan.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import com.hongguoyan.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import com.hongguoyan.module.bpm.controller.admin.task.vo.instance.*;
import com.hongguoyan.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import com.hongguoyan.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import com.hongguoyan.module.bpm.convert.task.BpmProcessInstanceConvert;
import com.hongguoyan.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import com.hongguoyan.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import com.hongguoyan.module.bpm.enums.ErrorCodeConstants;
import com.hongguoyan.module.bpm.enums.definition.BpmModelTypeEnum;
import com.hongguoyan.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import com.hongguoyan.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import com.hongguoyan.module.bpm.enums.task.BpmReasonEnum;
import com.hongguoyan.module.bpm.enums.task.BpmTaskStatusEnum;
import com.hongguoyan.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import com.hongguoyan.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import com.hongguoyan.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import com.hongguoyan.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import com.hongguoyan.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import com.hongguoyan.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import com.hongguoyan.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import com.hongguoyan.module.bpm.framework.flowable.core.util.FlowableUtils;
import com.hongguoyan.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import com.hongguoyan.module.bpm.service.definition.BpmProcessDefinitionService;
import com.hongguoyan.module.bpm.service.message.BpmMessageService;
import com.hongguoyan.module.system.api.dept.DeptApi;
import com.hongguoyan.module.system.api.dept.dto.DeptRespDTO;
...
import static com.hongguoyan.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static com.hongguoyan.module.bpm.enums.ErrorCodeConstants.*;
import static com.hongguoyan.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static com.hongguoyan.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;
...
public class BpmProcessInstanceServiceImpl implements BpmProcessInstanceService {
    ...
    @DataPermission(enable = false) // 关闭数据权限，避免查询不到用户数据。相关案例：https://gitee.com/zhijiantianya/adjust-cloud/issues/ID1UYA
