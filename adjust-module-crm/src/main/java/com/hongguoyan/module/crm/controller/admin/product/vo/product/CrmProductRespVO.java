package com.hongguoyan.module.crm.controller.admin.product.vo.product;
...
public class CrmProductRespVO implements VO {
    ...
    @Trans(type = TransType.SIMPLE, targetClassName = "com.hongguoyan.module.system.dal.dataobject.user.AdminUserDO",
