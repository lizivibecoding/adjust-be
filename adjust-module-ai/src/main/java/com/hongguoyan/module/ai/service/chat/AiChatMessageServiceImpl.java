package com.hongguoyan.module.ai.service.chat;
...
import com.hongguoyan.framework.tenant.core.util.TenantUtils;
import com.hongguoyan.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import com.hongguoyan.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
import com.hongguoyan.module.ai.controller.admin.chat.vo.message.AiChatMessageSendReqVO;
import com.hongguoyan.module.ai.controller.admin.chat.vo.message.AiChatMessageSendRespVO;
...
import com.hongguoyan.module.ai.dal.dataobject.knowledge.AiKnowledgeDocumentDO;
import com.hongguoyan.module.ai.dal.dataobject.model.AiChatRoleDO;
import com.hongguoyan.module.ai.dal.dataobject.model.AiModelDO;
import com.hongguoyan.module.ai.dal.dataobject.model.AiToolDO;
import com.hongguoyan.module.ai.dal.mysql.chat.AiChatMessageMapper;
import com.hongguoyan.module.ai.enums.ErrorCodeConstants;
...
import com.hongguoyan.module.ai.framework.ai.core.webserch.AiWebSearchRequest;
import com.hongguoyan.module.ai.framework.ai.core.webserch.AiWebSearchResponse;
import com.hongguoyan.module.ai.service.knowledge.AiKnowledgeDocumentService;
import com.hongguoyan.module.ai.service.knowledge.AiKnowledgeSegmentService;
import com.hongguoyan.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchReqBO;
import com.hongguoyan.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchRespBO;
import com.hongguoyan.module.ai.service.model.AiChatRoleService;
import com.hongguoyan.module.ai.service.model.AiModelService;
import com.hongguoyan.module.ai.service.model.AiToolService;
import com.hongguoyan.module.ai.util.AiUtils;
import com.hongguoyan.module.ai.util.FileTypeUtils;
...
import static com.hongguoyan.framework.common.pojo.CommonResult.error;
import static com.hongguoyan.framework.common.pojo.CommonResult.success;
import static com.hongguoyan.framework.common.util.collection.CollectionUtils.convertList;
import static com.hongguoyan.framework.common.util.collection.CollectionUtils.convertSet;
import static com.hongguoyan.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static com.hongguoyan.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    @Autowired(required = false) // 由于 adjust.ai.web-search.enable 配置项，可以关闭 AiWebSearchClient 的功能，所以这里只能不强制注入
    private AiWebSearchClient webSearchClient;

    @SuppressWarnings("SpringJavaAutowiredFieldsWarningInspection")
    @Autowired(required = false) // 由于 adjust.ai.mcp.client.enable 配置项，可以关闭 McpSyncClient 的功能，所以这里只能不强制注入
