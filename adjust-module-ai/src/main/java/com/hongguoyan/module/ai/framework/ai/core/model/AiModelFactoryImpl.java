package com.hongguoyan.module.ai.framework.ai.core.model;
...
import com.hongguoyan.framework.common.util.spring.SpringUtils;
import com.hongguoyan.module.ai.enums.model.AiPlatformEnum;
import com.hongguoyan.module.ai.framework.ai.config.AiAutoConfiguration;
import com.hongguoyan.module.ai.framework.ai.config.AdjustAiProperties;
...
import com.hongguoyan.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import com.hongguoyan.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            AdjustAiProperties.Midjourney properties = SpringUtil.getBean(AdjustAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(AdjustAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        AdjustAiProperties.DouBao properties = new AdjustAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(AdjustAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        AdjustAiProperties.HunYuan properties = new AdjustAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(AdjustAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        AdjustAiProperties.SiliconFlow properties = new AdjustAiProperties.SiliconFlow()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(AdjustAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        AdjustAiProperties.XingHuo properties = new AdjustAiProperties.XingHuo()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(AdjustAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        AdjustAiProperties.BaiChuan properties = new AdjustAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(AdjustAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        AdjustAiProperties.Gemini properties = SpringUtil.getBean(AdjustAiProperties.class)
    ...
    private ChatModel buildGrokChatModel(String apiKey,String url) {
        AdjustAiProperties.Grok properties = new AdjustAiProperties.Grok()
                .setBaseUrl(url)
                .setApiKey(apiKey);
