package com.hongguoyan.framework.tracer.config;

import com.hongguoyan.framework.common.enums.WebFilterOrderEnum;
import com.hongguoyan.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "adjust.tracer", value = "enable", matchIfMissing = true)
public class AdjustTracerAutoConfiguration {
