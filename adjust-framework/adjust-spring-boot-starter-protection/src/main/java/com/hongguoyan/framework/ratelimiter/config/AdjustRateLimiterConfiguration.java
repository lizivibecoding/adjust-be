package com.hongguoyan.framework.ratelimiter.config;

import com.hongguoyan.framework.ratelimiter.core.aop.RateLimiterAspect;
import com.hongguoyan.framework.ratelimiter.core.keyresolver.RateLimiterKeyResolver;
import com.hongguoyan.framework.ratelimiter.core.keyresolver.impl.*;
import com.hongguoyan.framework.ratelimiter.core.redis.RateLimiterRedisDAO;
...
public class AdjustRateLimiterConfiguration {
