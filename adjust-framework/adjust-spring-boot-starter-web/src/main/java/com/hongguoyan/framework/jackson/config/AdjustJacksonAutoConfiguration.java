package com.hongguoyan.framework.jackson.config;

import com.hongguoyan.framework.common.util.json.JsonUtils;
import com.hongguoyan.framework.common.util.json.databind.NumberSerializer;
import com.hongguoyan.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import com.hongguoyan.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class AdjustJacksonAutoConfiguration {
