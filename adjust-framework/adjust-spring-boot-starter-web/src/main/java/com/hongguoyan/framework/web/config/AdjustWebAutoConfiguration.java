package com.hongguoyan.framework.web.config;
...
import com.hongguoyan.framework.web.core.filter.CacheRequestBodyFilter;
import com.hongguoyan.framework.web.core.filter.DemoFilter;
import com.hongguoyan.framework.web.core.handler.GlobalExceptionHandler;
import com.hongguoyan.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class AdjustWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "adjust.demo", havingValue = "true")
